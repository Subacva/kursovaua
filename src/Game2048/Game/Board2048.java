...
public class Board2048 {
    ...
    /**
     * ВСТАВЛЯЕТ СЛУЧАЙНЫЙ ТАЙТЛ В РАНДОМНОЕ ПОЛЕ
     */
    ...
    /**
     ДВИГАЕТ ПОЛЕ БЕЗ СОЗДАНИЯ ТАЙТЛОВ (ДЛЯ АЛГОРИТМА)
     */
